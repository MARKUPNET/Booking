...
<div class="container">
    ...
    <div class="bookingForm p-5">
        ...
        <form method="post" action="{{ route('booking-form.confirm') }}">
            {{ csrf_field() }}
            <table class="table table-bordered booking-option-entry entry-field">
                <tbody>
                    <tr>
            ...
            <div id="mtsab-booking-action" class="row">
                <p class="col-12 text-center"><button type="submit" name="action" value="submit" class="btn btn-primary">確認する</button></p>
                <p class="col-12 text-center"><button type="submit" name="action" value="back" class="btn btn-light">戻る</button></p>
            </div>
        </form>
    </div>
